...
function initAction() {
    ...
    setTimeout(function(){
        document.querySelector('#hpmdf-shadow').style.opacity = '0';
        sendMessage({name: "hpmd", action: "change-logo"});
        items.msg1.isAlive = true;
        items.msg3.isAlive = false;
        items.arrow.isMove = true;
        can.isMove = true;
...
function update() {
    ...
    items.arrow.isMove && items.arrow.move();
